...
//         "http://127.0.0.1:8000/api/sumwords/sum/",
//         formData,
...
import { useState } from "react";
import axios from "axios";
import { FiUploadCloud, FiHash, FiZap } from "react-icons/fi";
      ...
      <div className="max-w-5xl mx-auto bg-white shadow-2xl rounded-3xl p-10 border border-cyan-200">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Calculate total words from text or file
          </p>
        </div>
        ...
        <div className="text-center mt-6">
          ...
          >
            <FiZap />
            {loading ? "Processing..." : "Calculate Words"}
          </button>
        </div>
          ...
          <div className="mt-10 space-y-6">
            ...
            <div className="bg-cyan-50 p-5 rounded-2xl border border-cyan-200">
              <h2 className="flex items-center gap-2 font-bold text-cyan-700 mb-3">
                <FiHash /> Total Words: {result.word_count}
              </h2>
